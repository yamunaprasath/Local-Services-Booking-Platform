<footer class="footer-eight">
    <div class="footer-top">
        <img src="{{ asset('images/bg/footer-bg-03.png') }}" alt="img" class="footer-bg">
        <div class="container">
                ...
                <div class="row row-gap-3">
                    <div class="col-lg-7">
                        <div>
                            ...
                            <span class="text-white">Just sign up and we'll send you a notification by
                                email.</span>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2">
                                    ...
                                    <div class="fw-medium text-light"><a
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-center justify-content-lg-between flex-wrap gap-3">
                <div class="footer-links d-none d-lg-block">
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="hotel-grid.html">Hotels</a></li>
                        <li><a href="tour-grid.html">Tours</a></li>
                        <li><a href="car-grid.html">Car Rentals</a></li>
                        <li><a href="cruise-grid.html">Cruise</a></li>
                        <li><a href="activity-grid.html">Activities</a></li>
                    </ul>
                </div>
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <span class="text-white">Available on</span>
                    <a href="#" class="d-block">
                        <img src="{{ asset('images/icons/googleplay-white.svg') }}" alt="logo">
                    </a>
                    <a href="#" class="d-block">
                        <img src="{{ asset('images/icons/appstore-white.svg') }}" alt="logo">
                    </a>
                </div>
            </div>
        </div>
